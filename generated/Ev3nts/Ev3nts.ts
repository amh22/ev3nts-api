...
export class Ev3nts__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class Ev3nts extends ethereum.SmartContract {
  static bind(address: Address): Ev3nts {
    return new Ev3nts("Ev3nts", address);
  }

  idToEvent(param0: Bytes): Ev3nts__idToEventResult {
    ...
    return new Ev3nts__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(param0: Bytes): ethereum.CallResult<Ev3nts__idToEventResult> {
